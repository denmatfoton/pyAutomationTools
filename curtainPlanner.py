...
# RF codes names
curtainTopics = ["myhome/livingroom/curtain", "myhome/bedroom/curtain"]
...
for i in xrange(0, len(curtainEnabled)):
    ...
    curtainCmd = 'mosquitto_pub -t {} -m '.format(curtainTopics[i])
    curtainOpenCmd = curtainCmd + "open"
    curtainCloseCmd = curtainCmd + "close"
